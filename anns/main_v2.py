...
parser.add_argument('--data_root', type=str, help='parent directory where data is stored', default='Image_Library/')
# parser.add_argument('--csv_file_train', type=str, help='csv file for train metadata',default='meta_info/final_train_split.csv')
# parser.add_argument('--csv_file_val', type=str, help='csv file for val metadata',default='meta_info/final_test_split.csv')
parser.add_argument('--csv_file_train', type=str, help='csv file for train metadata',default='meta_info/latest_train_0305_v2.csv')
parser.add_argument('--csv_file_val', type=str, help='csv file for val metadata',default='meta_info/latest_test_0305_v2.csv')
parser.add_argument('--model_save', type=str, help='csv file containging all train metadata',default='model.pt')
parser.add_argument('--num_workers', type=int, help='csv file containging all train metadata',default=6)
...
parser.add_argument('--validation_split', type=float, help='Validation %', default=0.2)
...
parser.add_argument('--use_focal', action='store_true', help='Whether to pretrained backbone network')
parser.add_argument('--loss_type', type=str, help='loss type, choose from [CE,FL,CB,FLCB]',default='CE')
parser.add_argument('--use_log_freq', type=str, help='logging to wandb', default='False')
...
csv_file_type = 'meta_info/train_full_meta_new.csv' # read all classes information
